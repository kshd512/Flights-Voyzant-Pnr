 ...
 * @author MMT5680
 * 
 *         Swagger constants file for providing some default swagger UI values.
 *
 */
public class SwaggerConstants {
	...
	public static final String SWAGGER_API_TITLE = "VOYZANT PNR Service provider Rest API";
	public static final String SWAGER_CONTROLLER_SCANNER_PACKAGE = "com.mmt.flights.controllers";
}
