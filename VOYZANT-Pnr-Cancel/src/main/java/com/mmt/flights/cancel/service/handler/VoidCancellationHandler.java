...
public class VoidCancellationHandler extends CancellationBaseHandler implements FlowHandler<SupplyPnrCancelRequestDTO, SupplyPnrCancelResponseDTO> {

    public VoidCancellationHandler(HiveRequestResponseLogger hiveLogger) {
        super(hiveLogger, FunnelStep.Void);
    }
