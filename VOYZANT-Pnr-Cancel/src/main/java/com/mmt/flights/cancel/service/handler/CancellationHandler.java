...
public class CancellationHandler extends CancellationBaseHandler implements FlowHandler<SupplyPnrCancelRequestDTO, SupplyPnrCancelResponseDTO> {

    public CancellationHandler(HiveRequestResponseLogger hiveLogger) {
        super(hiveLogger, FunnelStep.Cancel);
    }
