...
public class PnrRetrieveResponseAdapterTest {
    ...
    public void testPnrRetrieveResponseAdapter() throws Exception {
        ...
        assertEquals(1, response.getBookingInfo().getFrInfo().getPnrGrpdFrInfoOrThrow(0).getPaxFaresMap().get("ADT").getNoOfPax());
